...
// Modificación importante aquí para evitar conflictos de tipo en la propiedad 'content'
// Usamos Omit para quitar 'content' de ambas interfaces para que no choquen
